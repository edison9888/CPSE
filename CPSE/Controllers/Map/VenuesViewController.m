...
- (void)viewDidLoad {
    ...
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"1号馆.jpg"];
        vc.title = @"1号馆";
    ...
    cell.backgroundColor = [UIColor colorWithHex:0x57b0ba];
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"6号馆.jpg"];
        vc.title = @"6号馆";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
    ...
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"2号馆.jpg"];
        vc.title = @"2号馆";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
    ...
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"3、4号馆.jpg"];
        vc.title = @"3、4号馆";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
    ...
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"5号馆.jpg"];
        vc.title = @"5号馆";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
    ...
    cell.backgroundColor = [UIColor colorWithHex:0xc08559];
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"7、8号馆.jpg"];
        vc.title = @"7、8号馆";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
    ...
    cell.backgroundColor = [UIColor colorWithHex:0xc08559];
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"9号馆.jpg"];
        vc.title = @"9号馆";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
    ...
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"二楼平台.jpg"];
        vc.title = @"二楼 平台";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
    ...
    cell.backgroundColor = [UIColor colorWithHex:0x967bbe];
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"二楼5号馆.jpg"];
        vc.title = @"二楼 5号馆";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
    ...
    cell.backgroundColor = [UIColor colorWithHex:0x967bbe];
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"二楼6号馆.jpg"];
        vc.title = @"二楼 6号馆";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
    ...
    cell.backgroundColor = [UIColor colorWithHex:0x967bbe];
    cell.tapHandler = ^{
        MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"北广场11号馆.jpg"];
        vc.title = @"北广场 11号馆";
        [self.navigationController pushViewController:vc animated:YES];
    };
    [self.view addSubview:cell];
...
- (void)viewWholeMap {
    MapViewController *vc = [[MapViewController alloc] initWithMapFile:@"展馆全图.jpg"];
    vc.title = @"展馆全图";
    [self.navigationController pushViewController:vc animated:YES];
}
